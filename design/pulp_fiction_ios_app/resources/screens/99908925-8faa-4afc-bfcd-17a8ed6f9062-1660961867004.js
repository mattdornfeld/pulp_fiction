jQuery("#simulation")
  .on("click", ".s-99908925-8faa-4afc-bfcd-17a8ed6f9062 .click", function(event, data) {
              ...
              "actions": [
                {
                  ...
                  "parameter": {
                    "target": "screens/38a4a1db-a449-4317-931a-dd30c94e046d"
                  },
                  "exectype": "serial",
                  "delay": 0
                }
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/65041cbb-d91b-43eb-ac7b-8126f4505ddd"
                  },
                  "exectype": "serial",
                  "delay": 0
                }
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/a70d6c07-48c0-47ed-b39c-081abf0af86b"
                  },
                  "exectype": "serial",
                  "delay": 0
                }
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/17911ee8-99c6-4132-9d24-b397deeaace2"
                  },
                  "exectype": "serial",
                  "delay": 0
                }
  ...
  .on("click", ".s-99908925-8faa-4afc-bfcd-17a8ed6f9062 .toggle", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
                ...
                "actions": [
                  {
                    "action": "jimShow",
                    "parameter": {
                      "target": [ "#s-Path_6","#s-Paragraph_2","#s-Rectangle_3","#s-Rectangle_4","#s-Path_8","#s-Path_7","#s-Path_5","#s-Paragraph_3" ]
                    },
                    "exectype": "serial",
                    "delay": 0
                  }
